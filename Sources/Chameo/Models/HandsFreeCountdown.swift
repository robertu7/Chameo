enum HandsFreeCountdownPhase: Equatable, Sendable {
    case inactive
    case armed
    case counting(Int)
    case locked
...
enum HandsFreeCountdownEvent: Equatable, Sendable {
...
enum HandsFreeCountdownEffect: Equatable, Sendable {
    case startTimer
    case cancelTimer
    case capture
}

struct HandsFreeCountdownMachine: Sendable {
    private static let correctiveSampleLimit = 3

    private(set) var phase = HandsFreeCountdownPhase.inactive

...
final class CameraSelectionPolicyTests: XCTestCase {
    func testMobileRotationAnglesCoverEverySupportedOrientation() {
        XCTAssertEqual(MobileCameraOrientationPolicy.clockwiseRotationAngle(for: .portrait), 90)
        XCTAssertEqual(MobileCameraOrientationPolicy.clockwiseRotationAngle(for: .portraitUpsideDown), 270)
        XCTAssertEqual(MobileCameraOrientationPolicy.clockwiseRotationAngle(for: .landscapeLeft), 0)
        XCTAssertEqual(MobileCameraOrientationPolicy.clockwiseRotationAngle(for: .landscapeRight), 180)
    }
